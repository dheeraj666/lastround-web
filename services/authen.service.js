...
(function () {
    ...
    angular
        .module('app')
        .factory('AuthenService', AuthenService);

    AuthenService.$inject = ['$http', '$cookies', '$rootScope', '$timeout', 'API'];
    function AuthenService($http, $cookies, $rootScope, $timeout, API) {
        var service = {};
        ...
        function getAuthen() {
            $rootScope.userAccessToken = $cookies.get('_lrtk');
            ...
            $rootScope.isLoggedIn = true;
            let sub = $cookies.get('isSubscribed');
            if (sub == 'true')
